...
# Keep approved v24 artwork and v25 navigation; v25.06 maximizes Summary View numbers only.
for file in mobile.css app-mobile.js v02403.css v02501-ui.js v02503-summary.css v02505-summary.css v02506-summary.css v02505-summary.js v02506-fit.js v02501-navigation.js v02506-version.js; do
...
for css in ['mobile.css', 'v02403.css', 'v02503-summary.css', 'v02505-summary.css', 'v02506-summary.css']:
    if f'href="{css}"' not in s:
        s = s.replace('</head>', f'  <link rel="stylesheet" href="{css}">\n</head>', 1)
for js in ['app-mobile.js', 'v02501-ui.js', 'v02505-summary.js', 'v02506-fit.js', 'v02501-navigation.js', 'v02506-version.js']:
    if f'src="{js}"' not in s:
        s = s.replace('</body>', f'  <script src="{js}"></script>\n</body>', 1)
p.write_text(s, encoding='utf-8')
PY

echo "Imported approved v24 design with v0.25.06 max-font 4/5-row movement Summary View into: $TARGET"
